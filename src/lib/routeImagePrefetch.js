const ROUTE_CRITICAL_IMAGES = Object.freeze({
    "/services": [
        ...
        "/icons/service-checkup-mobile.svg",
    ...
    "/declaration": ["/images/declaration-hero.webp"],
    "/consultation": ["/images/consult-hero.webp"],
    "/diagnostics": ["/images/diagnostics-hero.webp"],
    "/manipulation": ["/images/manipulation-hero.webp"],
    "/vaccination": ["/images/vaccination-hero.webp"],
    "/packages": ["/images/packages-hero-nurse.webp"],
    "/checkup": ["/images/consultation.webp"],
    "/screening-40-plus": ["/images/consultation.webp"],
    "/analyses": ["/images/analyses-hero.webp"],
    "/vacancies": ["/images/vacancy-hero.webp"],
});
