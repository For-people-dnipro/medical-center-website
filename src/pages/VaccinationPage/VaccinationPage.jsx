...
const vaccinationFaqs = [
    ...
    },
    {
        ...
        answer: [
            "Після щеплення можлива незначна місцева реакція: почервоніння, чутливість у місці ін'єкції або короткочасне підвищення температури.",
            "Це нормальна відповідь імунної системи.",
        ],
    },
    {
        question: "Чи можна вакцинуватися при застуді або нежиті?",
        answer: [
            "Рішення приймає лікар після огляду.",
            "За легкої симптоматики без температури вакцинація може бути можливою, але остаточну рекомендацію надає спеціаліст на прийомі.",
        ],
    },
    {
        question: "Чи можна робити декілька вакцин в один день?",
        answer: [
            "У багатьох випадках так — це безпечно згідно з міжнародними протоколами.",
            "Схему та поєднання вакцин лікар визначає індивідуально.",
        ],
    },
    {
        question: "Чи можна займатися спортом після щеплення?",
        answer: [
            "Після вакцинації організм активно формує імунну відповідь, тому протягом перших 24–48 годин рекомендується уникати інтенсивних фізичних навантажень.",
            "Це не через небезпеку, а щоб не створювати додатковий стрес для організму.",
        ],
    },
    {
